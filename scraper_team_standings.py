...
def start_live_updating(season="2024-2025", interval_per_league=60, cooldown_between_cycles=300):
    ...
    while True:
        ...
        print(f"\n🔁 All leagues updated. Waiting {cooldown_between_cycles // 60} minutes before next full cycle...\n")
